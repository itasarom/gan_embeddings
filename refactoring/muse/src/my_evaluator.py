...
from muse.src.evaluation import get_wordsim_scores, get_crosslingual_wordsim_scores
from muse.src.evaluation.word_translation import get_word_translation_accuracy
...
class Evaluator(object):
    ...
    def __init__(self, src_dico, src_emb,  tgt_dico, tgt_emb):
        """
    ...
    def monolingual_wordsim(self, to_log):
        ...
        src_ws_scores = get_wordsim_scores(
            ...
            self.src_emb.weight.data.cpu().numpy()
        )
    ...
    def crosslingual_wordsim(self, to_log):
        ...
        src_emb = self.src_emb.weight.data.cpu().numpy()
    ...
    def word_translation(self, to_log, path):
        """
